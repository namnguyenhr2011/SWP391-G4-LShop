...
const DeleteProduct = () => {
  ...
  // Khi chọn Category, load SubCategory
  ...
  // Khi chọn SubCategory, load danh sách sản phẩm
  const handleSubCategoryChange = async (subCategoryId) => {
    setSelectedSubCategory(subCategoryId);
    try {
      const response = await getAllProductBySubCategory(subCategoryId); // Sử dụng đúng API
      if (response && response.products) {
        setProducts(response.products); // Cập nhật dữ liệu sản phẩm
      } else {
